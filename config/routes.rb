Rails.application.routes.draw do
  ...
  get '/analytics' => 'networks#analytics'
  
  post '/deletetrackgoal' => 'networks#deletetrackgoal'
  post '/edittrackgoal' => 'networks#edittrackgoal'
  post '/addtrackgoal' => 'networks#addtrackgoal'


  get '/releasenotes' => 'networks#releasenotes'

  post '/campaignsettingupdate' => 'networks#campaignsettingupdate'

  post '/quickedit/keyword' => 'networks#quickeditkeyword'
  post '/quickadd/keyword' => 'networks#quickaddkeyword'

  get '/watchdog/history' => 'networks#watchdoghistory'

  post '/getwatchdogreport' => 'networks#getwatchdogreport'

  get '/pricing' => 'homes#pricing'
  get '/demo' => 'homes#demo'
  get '/contact_us' => 'homes#contact_us'
  get '/services' => 'homes#services'


  get '/services/search_engine_marketing' => 'homes#searchenginemarketing'
  get '/services/search_engine_optimization' => 'homes#searchengineoptimization'
  get '/services/social_media_marketing' => 'homes#socialmediamarketing'
  get '/services/content_localisation' => 'homes#contentlocalisation'
  ...
  get '/demo_thank_you' => 'homes#demo_thank_you'
  get '/contact_us_thank_you' => 'homes#contact_us_thank_you'
...
#
  ...
  post '/campaign_api_sync' => 'networks#campaign_api_sync'
  post '/adgroup_api_sync' => 'networks#adgroup_api_sync'
  ...
  get '/account/goals' => 'users#goals' # leon goals
  ...
  post '/baidu/updatead' => 'networks#baiduupdatead'
  post '/shenmas/updatead' => 'networks#shenmaupdatead'


  post '/sogous/updatekeyword' => 'networks#sogouupdatekeyword'
  post '/threesixties/updatekeyword' => 'networks#threesixtyupdatekeyword'
  post '/baidu/updatekeyword' => 'networks#baiduupdatekeyword'
  post '/shenmas/updatekeyword' => 'networks#shenmaupdatekeyword'


  post '/sogous/updateadgroup' => 'networks#sogouupdateadgroup'
  post '/threesixties/updateadgroup' => 'networks#threesixtyupdateadgroup'
  post '/baidu/updateadgroup' => 'networks#baiduupdateadgroup'
  post '/shenmas/updateadgroup' => 'networks#shenmaupdateadgroup'
  ...
  post '/getcampaignbynetworkid/:id' => 'networks#getcampaignbynetworkid'
  # post '/getadgroupbynetworkid/:type/:id' => 'networks#getadgroupbynetworkid'

  post '/getadgroupbycampaignid/:type/:id' => 'networks#getadgroupbycampaignid'
