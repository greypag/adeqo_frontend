class UsersController < ApplicationController
  ...
  def goals
      @goals = @db[:conversion_rules].find('company_id' => @user_company_id)
      @db.close()
  end
...
#     
  ...
  def logout
    ...
    session[:watchdog_end_date] = nil
    session[:watchdog_start_date] = nil
    
    session[:bulk_end_date] = nil
    session[:bulk_start_date] = nil
    
    session[:adv_end_date] = nil
    session[:adv_start_date] = nil
